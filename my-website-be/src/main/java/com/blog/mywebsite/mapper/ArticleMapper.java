...
public interface ArticleMapper {
    ...
    Map<Integer, List<ArticleOutput>> toArticleOutputMapForYear(Map<Integer, List<ArticleDTO>> articleDTOMap);
    Map<String, List<ArticleOutput>> toArticleOutputMapForCategoryName(Map<String, List<ArticleDTO>> articleDTOMap);
